 ...
 * more than a {@link BookItemDetailFragment}.
 */
public class BookItemDetailActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, BookItemListActivity.class));
            return true;
        }
